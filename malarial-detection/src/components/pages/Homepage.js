      ...
      <div className="d-flex part1 col-md-12">
        ...
        <div className="side1 col-md-6 float-left">
          ...
          <div className="sidetext">
            ...
            deaths stood at 405,000 in 2018
          </div>
          <a className="gradient-button gradient-button-1" href="#">Get Started</a><br />
        </div> 
      </div>
      ...
      <div className="d-flex part2 col-md-12">
        ...
        <div className="side2 col-md-6 float-right ml-auto">
          <div className="sidetext">
            ...
            <div className="text2">
              To detect and identify <strong>Malarial Cell</strong> this tool provides 95% accuracy and help different communities 
            </div>
          </div>
          <a className="gradient-button gradient-button-1 btn2" href="#">Launch Detector</a><br />
        </div> 
      </div>
    </div>
  );
